...
| [mcplot family](mcplot.md) | `mcplot`, `mcplotdiff`, `mccoplot` — html / matplotlib / pyqtgraph / matlab variants |
| [mcdisplay family](mcdisplay.md) | `mcdisplay` — pyqtgraph (default) / matplotlib / webgl / webgl-classic / cad / matlab variants |
| [mctest family](mctest.md) | `mctest`, `mcviewtest` |
...
| Plot one simulation's results | [`mcplot-{html,matplotlib,pyqtgraph}`](mcplot.md#mcplot-mxplot) |
| Compare exactly two simulations (`a - b`) | [`mcplotdiff-{html,matplotlib,pyqtgraph}`](mcplot.md#mcplotdiff-mxplotdiff) |
| Overlay 2+ simulations for direct comparison | [`mccoplot-{html,matplotlib,pyqtgraph}`](mcplot.md#mccoplot-mxcoplot) |
| Visualise instrument geometry + particle trajectories | [`mcdisplay-{pyqtgraph,matplotlib,webgl,webgl-classic}`](mcdisplay.md) |
| Export instrument geometry to a CAD file | [`mcdisplay-cad`](mcdisplay.md#mcdisplay-cad-mxdisplay-cad-bonus-export-instrument-geometry-to-cad) |
| Plot/display results in Matlab, Octave, or iFit instead | [`mcplot-matlab`](mcplot.md#mcplot-matlab-mxplot-matlab-legacy-matlaboctaveifit-variant) / [`mcdisplay-matlab`](mcdisplay.md#mcdisplay-matlab-mxdisplay-matlab-legacy-matlaboctaveifit-variant) |
| Test/benchmark the whole instrument library against a McCode installation | [`mctest`](mctest.md#mctest-mxtest) |
| Build a browsable pass/fail + diff report from `mctest` results | [`mcviewtest`](mctest.md#mcviewtest-mxviewtest) |
| Generate/browse instrument & component documentation | [`mcdoc`](mcdoc.md) |
